...
% spiketrain
line([thisData.spikeTimesInSeconds'; thisData.spikeTimesInSeconds'], [-450; -400], 'Color', 'k', 'LineWidth', 1);
...
% figure
circDistSig             = figure;
polarhistogram(thisData.circDiff, params.polarHistEdges, 'FaceColor', [0.16, 0.16, 0.16], 'FaceAlpha', 0.2);
hold on;
polarhistogram(thisData.circDiffSig, params.polarHistEdges, 'FaceColor', [0.16, 0.16, 0.16]);
rlim([0, 10]);
set(gca, 'ThetaTickLabel', params.polarHistLabels);
...
% figure
circDistSig             = figure;
polarhistogram(thisData.circDiffSucc, params.polarHistEdges, 'FaceColor', [0.1, 0.6, 0.1], 'FaceAlpha', 0.2);
hold on;
polarhistogram(thisData.circDiffSigSucc, params.polarHistEdges, 'FaceColor', [0.1, 0.6, 0.1]);
rlim([0, 10]);
set(gca, 'ThetaTickLabel', params.polarHistLabels);
...
% figure
circDistSig             = figure;
polarhistogram(thisData.circDiffFail, params.polarHistEdges, 'FaceColor', [0.6, 0.1, 0.1], 'FaceAlpha', 0.2);
hold on;
polarhistogram(thisData.circDiffSigFail, params.polarHistEdges, 'FaceColor', [0.6, 0.1, 0.1]);
rlim([0, 10]);
set(gca, 'ThetaTickLabel', params.polarHistLabels);
...
axes('units', 'normalized', 'position', [0.1, 0.2, 0.6, 0.7]);
...
% surrogate distribution
axes('units', 'normalized', 'position', [0.75, 0.2, 0.2, 0.7]);
...
bar([1, 2], [mean(thisData.successfulTaskFrequencies, 'omitnan'), mean(thisData.unsuccessfulTaskFrequencies, 'omitnan')], 'FaceColor', [0.5, 0.5, 0.5]);
hold on;
